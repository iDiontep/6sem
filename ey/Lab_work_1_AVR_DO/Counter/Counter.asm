...
Init_C:   ser   temp;  (PС0-PС7) - выходы
	      out   DDRC,temp
	      ldi   temp,0b00111111;код "0" при включении	    
	      out   PORTC,temp;
;
Init_CNT: clr   Counter;сброс счетчика при включении
...
Start:    sbic  PinB,4    ;кнопка нажата?
	      ...
	      inc   Counter   ;да, увеличиваем счетчик на 1
	   
          cpi   Counter,10;Counter=10?
	      brne  PC+2      ;Нет, пропускаем команду
	      clr   Counter   ;да, сбрасываем счетчик 
;	   
