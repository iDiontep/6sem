...
; Constants
;*****************
.equ Val_del1=0x40;0x40;величина константы задержки
.equ Val_del2=0x3F;0x1F;(защитной паузы)            
;-------------------------
.dseg
Var_buffer: .BYTE 8
;***********************************
...
IN_INT0:   push   temp_L
		   ...
		   push   temp_L 
;
           ldi    temp_L,Val_del1;загрузка констант
           ldi    temp_H,Val_del2
		   rcall  Delay_DK
